  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          title="Our Community"
          icon={<AceternityIcon order="Principle 3" />}
          des="Our Community is you! Everyone is welcome to be a part of our friendly and welcoming community. We guarantee an unforgettable experience that is as perfect as possible!"
        >
          <CanvasRevealEffect
            animationSpeed={3}
